...
run("Analyze Particles...", "size=1000-Infinity pixel display clear add composite summarize");
...
Table.renameColumn("Slice", "Mask");
Table.rename("Summary", "Results");
run("Read and Write Excel", "dataset_label=[Summary] no_count_column file=[" + path + "Results" + "_excel.xlsx] sheet=VAST");
//activate batchmode
setBatchMode(true);
